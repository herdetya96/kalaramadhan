...
const DOA_LIST: Doa[] = [
  {
    id: 1, title: "Doa Sebelum Makan", category: "Harian",
    arabic: "اَللّٰهُمَّ بَارِكْ لَنَا فِيْمَا رَزَقْتَنَا وَقِنَا عَذَابَ النَّارِ",
    latin: "Allahumma baarik lanaa fiimaa razaqtanaa wa qinaa 'adzaa ban naar",
  ...
  {
    id: 2, title: "Doa Sesudah Makan", category: "Harian",
    ...
    translation: "Segala puji bagi Allah yang telah memberi kami makan dan minum serta menjadikan kami termasuk orang-orang Islam.",
  },
  {
    id: 3, title: "Doa Sebelum Tidur", category: "Harian",
  ...
  {
    id: 4, title: "Doa Bangun Tidur", category: "Harian",
  ...
  {
    id: 7, title: "Doa Masuk Kamar Mandi", category: "Harian",
  ...
  {
    id: 8, title: "Doa Keluar Kamar Mandi", category: "Harian",
    arabic: "غُفْرَانَكَ",
    latin: "Ghufraanak",
    translation: "Aku memohon ampun kepada-Mu.",
  },
  {
    id: 9, title: "Doa Bercermin", category: "Harian",
    arabic: "اَللّٰهُمَّ كَمَا حَسَّنْتَ خَلْقِيْ فَحَسِّنْ خُلُقِيْ",
    latin: "Allaahumma kamaa hassanta khalqii fahassin khuluqii",
    translation: "Ya Allah, sebagaimana Engkau perindah kejadianku, maka perindah pula akhlakku.",
  },
  {
    id: 10, title: "Doa Keluar Rumah", category: "Harian",
    arabic: "بِسْمِ اللّٰهِ تَوَكَّلْتُ عَلَى اللّٰهِ لَا حَوْلَ وَلَا قُوَّةَ إِلَّا بِاللّٰهِ",
    latin: "Bismillaahi tawakkaltu 'alallaahi laa hawla walaa quwwata illaa billaah",
    translation: "Dengan nama Allah, aku bertawakal kepada Allah, tidak ada daya dan kekuatan kecuali dengan pertolongan Allah.",
  },
  {
    id: 11, title: "Doa Masuk Rumah", category: "Harian",
  ...
  {
    id: 12, title: "Doa Berbuka Puasa", category: "Ramadan",
  ...
  {
    id: 13, title: "Doa Niat Puasa", category: "Ramadan",
    ...
    translation: "Aku niat berpuasa esok hari untuk menunaikan kewajiban di bulan Ramadan tahun ini karena Allah Ta'ala.",
  },
  {
    ...
    translation: "Maha Suci Allah yang telah menundukkan semua ini untuk kami padahal kami sebelumnya tidak mampu menguasainya. Dan sesungguhnya kami akan kembali kepada Tuhan kami.",
  },
  {
    id: 15, title: "Doa Ketika Hujan", category: "Alam",
  ...
  {
    id: 16, title: "Doa Memakai Pakaian", category: "Harian",
    arabic: "اَلْحَمْدُ لِلّٰهِ الَّذِيْ كَسَانِيْ هٰذَا وَرَزَقَنِيْهِ مِنْ غَيْرِ حَوْلٍ مِنِّيْ وَلَا قُوَّةٍ",
    latin: "Alhamdulillaahil ladzii kasaanii haadzaa wa razaqaniihi min ghairi hawlin minnii walaa quwwah",
    translation: "Segala puji bagi Allah yang telah memberiku pakaian ini dan memberi rezeki tanpa daya dan kekuatan dariku.",
  },
];
    ...
    <div className="min-h-screen bg-white pb-24 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col pt-6 px-4 gap-4">
        ...
        <div className="flex items-center w-full">
          ...
          <h1 className="text-xl font-bold flex-1 text-center pr-10" style={{ color: '#1D293D', letterSpacing: '-0.44px' }}>Doa Harian</h1>
        </div>

        {/* Search */}
        <div className="relative">
          <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4" style={{ color: '#90A1B9' }} />
          <input
            type="text"
        ...
        <div className="flex gap-2 overflow-x-auto pb-1 no-scrollbar">
          {CATEGORIES.map((cat) => (
            <button
              ...
              style={{
                background: activeCategory === cat ? 'linear-gradient(180deg, #7DF8AD 0%, #F9FFD2 100%)' : '#F8F8F7',
                border: activeCategory === cat ? '1px solid #FFFFFF' : '1px solid #F3EDE6',
                color: activeCategory === cat ? '#065F46' : '#62748E',
                boxShadow: activeCategory === cat ? '0px 4px 14px rgba(0, 0, 0, 0.1)' : 'none',
              }}
            >
              {cat}
            </button>
        ...
        <div className="flex flex-col gap-2 pb-6">
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex flex-col">
                  <span className="font-semibold text-sm" style={{ color: '#1D293D' }}>{doa.title}</span>
                  <span className="text-xs" style={{ color: '#838A96' }}>{doa.category}</span>
                </div>
                <span
              ...
              {expandedId === doa.id && (
                ...
                >
                  ...
                  <p className="text-sm" style={{ color: '#314158' }}>{doa.translation}</p>
                </motion.div>
              )}
            </motion.div>
          ))}
          ...
          {filtered.length === 0 && (
            <div className="text-center py-10">
              <span className="text-sm" style={{ color: '#838A96' }}>Doa tidak ditemukan</span>
            </div>
          )}
        </div>
      </div>
